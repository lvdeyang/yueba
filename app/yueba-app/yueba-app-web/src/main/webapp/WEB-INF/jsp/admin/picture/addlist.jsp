...
{{#  layui.each(d.list, function(index, item){ }}
						...
						<td>
                            <img  src={{ item.webUrl }} width="30" height="30">	
                        </td>
                        <td>
                            {{ item.oldName }}
                        </td>
						...
						<td>
                        	<a title="添加" href="javascript:;" onclick="addImg('{{ item.folde }}','{{ item.newName }}','{{ item.id }}')" 
...
{{#  } }} 
	...
	function fenye(){
 		...
 		function addImg(folde,url,id)
 		{
		  img = "<td><img alt='' style='height:100px;width:100px'  src='"+webUrl+"/"+folde+"/"+url+"'>" 	
		  imgids ="<input type='hidden' class='imgid' value='"+id+"'></td>"	
 		  console.log(img);
 		  console.log(imgids);
 		  parent.$("#${sel}").append(img,imgids);
 		  console.log("${sel}");
