...
<body>
	...
	<div class="x-body">
		...
		<span id=count class="x-right" style="line-height:40px">共有数据：${allcount}
			条</span></xblock>
...
{{#  layui.each(d.list, function(index, item){ }}
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="merchant_edit('编辑','check','{{ item.uuid }}','','510')"
