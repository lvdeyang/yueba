...
public class Md5Utils {
    ...
    public static String getOpenLDAPMD5(String srcPasswdStr) {
        byte[] md5Bytes = encodeMD5(srcPasswdStr);
        String rtnStr = encodeBase64(md5Bytes);
